...
- [My First Django Project](#my-first-django-project)
  * [1. Start Project](#1-start-project)
  * [2. Start APP](#2-start-app)
  * [3. Admin](#3-admin)
  * [4. shell_plus](#4-shell-plus)
    + [shell](#shell)
    + [shell_plus란?](#shell-plus--)
    + [shell_plus로 DB 데이터 조작하기](#shell-plus--db---------)
  * [5. CRUD](#5-crud)
    + [CREATE](#create)
    + [READ](#read)
      - [index 페이지](#index----)
  ...
  * [6. 문제점 및 해결방법](#6-----------)
    + [(1) url에 대한 문제점](#-1--url--------)
    + [(2) Template에 대한 문제점](#-2--template--------)
      - [템플릿 상속](#------)
      - [동적 템플릿](#------)
    + [(3) 뷰 함수에 대한 문제점](#-3--------------)
  * [7. Form](#7-form)
    + [forms.Form](#formsform)
    + [forms.ModelForm](#formsmodelform)
  * [8. accounts](#8-accounts)
    ...
    + [로그아웃](#----)
    + [로그인 여부 구별](#---------)
  * [9. article과 account 결합](#9-article--account---)
    + [1:N 데이터베이스](#1-n-------)
  * [10. 댓글](#10---)
    + [모델](#--)
    + [폼](#-)
